...
{
    public partial class ImageArea : Form
    {
        ...
        public ImageArea(LedNetSdkDemo.PicArea PicArea)
        {
            picArea = PicArea;
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)//添加文件
        {
            string szFileName;
            if (openFileDialog2.ShowDialog() == DialogResult.OK)
            {
                szFileName = openFileDialog2.FileName;
                listBox1.Items.Add(szFileName);
                LedNetSdkDemo.ImgText picUnit;
                picUnit.bPic = false;
                picUnit.FileName = szFileName;
        ...
        private void button5_Click(object sender, EventArgs e)//取消
        {
            bl = false;
            this.Close();
        }
