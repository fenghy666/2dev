...
//------------------------------------------------------------------------------
        ...
        #define BX_6Q1  0x0166
		#define BX_6Q2  0x0266
		#define BX_6Q2L  0x0466
		#define BX_6Q3  0x0366
		#define BX_6Q3L  0x0566

		int controlType[11]  =  {BX_5E1,BX_5E2,BX_5E3,BX_5Q0P,BX_5Q1P,BX_5Q2P,BX_6Q1,BX_6Q2,BX_6Q2L,BX_6Q3,BX_6Q3L};
	...
	: CDialogEx(CVC_DemoDlg::IDD, pParent)
{
	...
	DeleteScreenDynamicArea = (pDeleteScreenDynamicArea)GetProcAddress(hInst,"DeleteScreenDynamicArea");
	...
	SendDynamicAreasInfoCommand = (pSendDynamicAreasInfoCommand)GetProcAddress(hInst,"SendDynamicAreasInfoCommand");
...
void CVC_DemoDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_RADIO10, m_ctrlRadio10);
...
BOOL CVC_DemoDlg::OnInitDialog()
{
	...
	m_Combo1.InsertString(6,L"BX-6Q1");
	m_Combo1.InsertString(7,L"BX-6Q2");
	m_Combo1.InsertString(8,L"BX-6Q2L");
	m_Combo1.InsertString(9,L"BX-6Q3");
	m_Combo1.InsertString(10,L"BX-6Q3L");
	...
	m_ctrlRadio9.ShowWindow(TRUE);
	m_ctrlRadio10.ShowWindow(TRUE);
	...
	m_ctrlRadio10.SetCheck(TRUE);
	m_Edit26.SetWindowText(L"0");
...
void CVC_DemoDlg::OnBnClickedButton4()	//添加显示屏
{
	...
	dwNum = WideCharToMultiByte(CP_OEMCP,NULL,strServerIP,-1,NULL,NULL,0,NULL);
	...
	dwNum = WideCharToMultiByte(CP_OEMCP,NULL,strUserName,-1,NULL,NULL,0,NULL);
	...
	dwNum = WideCharToMultiByte(CP_OEMCP,NULL,strUserPassword,-1,NULL,NULL,0,NULL);
	...
	dwNum = WideCharToMultiByte(CP_OEMCP,NULL,strSaveFile,-1,NULL,NULL,0,NULL);
...
void CVC_DemoDlg::OnBnClickedButton6()	//添加文件
{
	...
	{		
		...
		nResult = AddScreenDynamicAreaFile(m_Spin1.GetPos(), m_Spin6.GetPos()
                , filename, nSingleLine,0, "宋体", 12, 0, 255
...
void CVC_DemoDlg::OnBnClickedButton10()	//更新动态区域函数
{
	...
	int DelAllDYArea;
	char* DYAreaIDList;
	if(m_ctrlRadio9.GetCheck() == 1)
	{
		DelAllDYArea = 1;
		DYAreaIDList = "";
		m_ctrlRadio10.SetCheck(FALSE);
	}
	if(m_ctrlRadio10.GetCheck() == 1)
	{
		DelAllDYArea = 0;
		CString nDYAreaIDList;
		m_Edit26.GetWindowText(nDYAreaIDList);
		DWORD dwNum = WideCharToMultiByte(CP_OEMCP,NULL,nDYAreaIDList,-1,NULL,NULL,0,NULL);
		DYAreaIDList = new char[dwNum];
		WideCharToMultiByte(CP_OEMCP,NULL,nDYAreaIDList,-1,DYAreaIDList,dwNum,0,NULL);
		m_ctrlRadio9.SetCheck(FALSE);
	}
	if (m_bSendBusy == false)
    {
		m_bSendBusy = true;
		nResult = SendDynamicAreasInfoCommand(m_Spin1.GetPos(), DelAllDYArea, DYAreaIDList);
...
void CVC_DemoDlg::OnBnClickedButton9()	//删除当前动态区域
{
    ...
    {
		m_bSendBusy = true;
		nResult = SendDeleteDynamicAreasCommand(m_Spin1.GetPos(), DelAllDYArea
            , DYAreaIDList);
...
void CVC_DemoDlg::OnBnClickedButton13()	//添加文本
{
	...
	nResult = AddScreenDynamicAreaText(m_Spin1.GetPos(), m_Spin6.GetPos()
                , "测试", nSingleLine,0, "宋体", 12, 0, 255
				, m_Combo10.GetCurSel(), m_Spin17.GetPos(), m_Spin18.GetPos());
	GetErrorMessage("执行AddScreenDynamicAreaText函数, ", nResult);
}


void CVC_DemoDlg::OnBnClickedButton8()
{
	// TODO: 在此添加控件通知处理程序代码
	int nResult = DeleteScreenDynamicArea(m_Spin1.GetPos(), m_Spin6.GetPos());
    GetErrorMessage("执行DeleteScreenDynamicArea函数,", nResult);
}
